				...
				<div class="row">
					<div class="col-lg-12">
						<table class="table table-hover">
							...
							<form class="form-reg" role="form" action="funcAddFb.php" method="POST">
								<div class="form-group">
									<label for="exampleInputEmail1">Раположение БД FireBird</label>
									<input type="text" name="dnsdb" class="form-control" id="exampleInputEmail1" placeholder="Пример: localhost:path\dbname">
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Имя сервера</label>
									<input type="text" name="nameserver" class="form-control" id="exampleInputEmail1" placeholder="Имя сервера">
								</div>
								<div class="form-group">
